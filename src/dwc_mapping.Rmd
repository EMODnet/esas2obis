...
write_csv(dwc_event, file.path(directory, "event.csv.gz"), na = "")
write_csv(dwc_occurrence, file.path(directory, "occurrence.csv.gz"), na = "")
write_csv(dwc_emof, file.path(directory, "emof.csv.gz"), na = "")
```
