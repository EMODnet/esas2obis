...
```{r}
species <- readr::read_csv(here::here("reference", "species.csv"), col_types = "c")
behaviour <- readr::read_csv(here::here("reference", "behaviour.csv"), col_types = "c")
shipc <- readr::read_csv(here::here("reference", "shipc.csv"), col_types = "c")
```
