...
DBI::dbWriteTable(esas_db, "glare", glare)
DBI::dbWriteTable(esas_db, "cloudcover", cloudcover)
DBI::dbWriteTable(esas_db, "precipitation", precipitation)
DBI::dbWriteTable(esas_db, "sightability", sightability)
DBI::dbWriteTable(esas_db, "observationdistance", observationdistance)
DBI::dbWriteTable(esas_db, "lifestage", lifestage)
DBI::dbWriteTable(esas_db, "moult", moult)
DBI::dbWriteTable(esas_db, "plumage", plumage)
DBI::dbWriteTable(esas_db, "sex", sex)
DBI::dbWriteTable(esas_db, "traveldirection", traveldirection)
DBI::dbWriteTable(esas_db, "preytype", preytype)
DBI::dbWriteTable(esas_db, "association", association)
