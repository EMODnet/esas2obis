...
Set limit for number of records (set to `100000000` in production, `NULL` is not supported by SQLite).
...
```{r}
esas_db <- DBI::dbConnect(RSQLite::SQLite(), ":memory:", extended_types = TRUE)
