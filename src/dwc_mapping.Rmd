...
required <- c("magrittr", "here", "glue", "jsonlite", "readr", "DBI", "icesVocab")
...
All data, to be used for IPT upload:
...
Sample of the data, to be used in git to notice mapping issues:
...
write_csv(dwc_event_sample, here::here("data", "processed_sample", "event.csv"), na = "")
write_csv(dwc_occurrence_sample, here::here("data", "processed_sample", "occurrence.csv"), na = "")
write_csv(dwc_emof_sample, here::here("data", "processed_sample", "emof.csv"), na = "")
```
